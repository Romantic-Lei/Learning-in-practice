...
从前而的set，getEntry，remove方法看出，在threadLocal的生命周期里，针对threadLocal存在的内存溃漏的问题，都会通过<font color = 'red'>expungeStaleEntry</font>,cleanSomeSlots,replaceStaleEntryi这三个方法清理掉key为null的entry。
