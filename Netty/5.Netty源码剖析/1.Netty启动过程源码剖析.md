...
channelFactory.newChannel()方法的作用通过 ServerBootstrap 的通道工厂反射创建一个NioServerSocketChannel，channelFactory工厂是通过传递过来的 NioServerSocketChannel 类，通过无参构造器反射获取 NioServerSocketChannel 对象，具体追踪源码可以得到下面结论
...
//说明：init 初始化这个 NioSerrerSocketChannel, 具体追踪源码可以得到如下结论
