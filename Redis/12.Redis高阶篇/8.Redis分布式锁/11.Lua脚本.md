...
- 上述设计修改为Lua脚本
  ...
  **V2版本**
  ...
  if redis.call('exists', 'key') == 0 or elseif redis.call('hexists', 'key', 'uuid:threadid') == 1 then
  	redis.call('hincrby', 'key', 'uuid:threadid', 1)
  	redis.call('expire', 'key', 50)
  	return 1
  else
  ...
  **V3版本**
  ...
  if redis.call('exists', KEYS[1]) == 0 or elseif redis.call('hexists', KEYS[1], ARGV[1]) == 1 then
